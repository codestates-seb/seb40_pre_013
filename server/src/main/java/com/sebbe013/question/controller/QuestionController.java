...
public class QuestionController {
    ...
    public QuestionController(
            QuestionService questionService, QuestionMapper mapper, AnswerService answerService, AnswerMapper answerMapper, MemberService memberService ){
    ...
    public ResponseEntity postQuestion(
            @RequestBody @Valid QuestionDto.Post questionPostDto, HttpServletRequest request ){
    ...
    public ResponseEntity patchMember(
            @PathVariable("question-id") @Positive long questionId, @RequestBody @Valid QuestionDto.Patch questionPatchDto, HttpServletRequest request ){
        ...
        return new ResponseEntity<>(new QuestionAnswersResponseDto<>(mapper.questionToQuestionResponseDto(question), answersResponse), HttpStatus.OK);
    }
    ...
    public ResponseEntity getQuestions(){
        ...
        List<QuestionDto.Response> response = questions.stream().map(question -> mapper.questionToQuestionResponseDto(question)).collect(Collectors.toList());
    ...
    public ResponseEntity deleteQuestion(
            @PathVariable("question-id") @Positive long questionId, HttpServletRequest request ){
